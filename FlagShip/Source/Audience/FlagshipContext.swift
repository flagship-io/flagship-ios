...
public enum FlagshipContext: String, CaseIterable {
    ...
    func chekcValidity(_ valueToSet: Any) -> Bool {
        switch self {
        case .DEVICE_LOCALE, .DEVICE_TYPE, .DEVICE_MODEL, .LOCATION_CITY, .LOCATION_REGION, .LOCATION_COUNTRY, .INTERNET_CONNECTION, .APP_VERSION_NAME, .FLAGSHIP_VERSION, .INTERFACE_NAME, .CARRIER_NAME, .OS_VERSION_NAME, .OS_VERSION_CODE, .OS_VERSION, .OS_NAME, .FS_Client, .FS_VERSION, .FS_USERS:
