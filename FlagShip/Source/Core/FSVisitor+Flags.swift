...
//        do {
//            guard let object = try? JSONSerialization.data(withJSONObject: ret) else {
//                return ""
//            }
//            return NSString(data: object, encoding: String.Encoding.utf8.rawValue) ?? ""
//        }
    }
}

extension Data {
    var prettyPrintedJSONStringB: NSString? { /// NSString gives us a nice sanitized debugDescription
