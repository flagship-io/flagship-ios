...
class ReconcileTest: XCTestCase {
    ...
    func testTupleAuthentication() {
        ...
        Flagship.sharedInstance.start(envId: "bkk9glocmjcg0vtmdlng", apiKey: "apiKey", visitorId: "ABCD-EFGH") { (_) in
    ...
    func testTupleAuthenticationWithLoggedSessionAtSatrt() {
        ...
        Flagship.sharedInstance.start(envId: "bkk9glocmjcg0vtmdlng", apiKey: "apiKey", visitorId: "Alex", config: FSConfig(authenticated: true)) { (_) in
            XCTAssert(Flagship.sharedInstance.visitorId == "Alex")
    ...
    func testAutheticateWithCtxNil() {
        ...
        Flagship.sharedInstance.authenticateVisitor(visitorId: "alex", visitorContext: nil) { (_) in
    ...
    func testAutheticateWithModifiedContext() {
        ...
        Flagship.sharedInstance.authenticateVisitor(visitorId: "alex", visitorContext: ["k11": "v1", "k22": "v2", "k33": "v3", "sdk_deviceLanguage": "fr"]) { (_) in
    ...
    func testunAutheticateWithNoNilCtx() {
        ...
        Flagship.sharedInstance.unAuthenticateVisitor(visitorContext: ["kilo": "bravo"]) { (_) in
    ...
    func testWithBucketing() {
        ...
        Flagship.sharedInstance.start(envId: "fkk9glocmjcg0vtmdlnh", apiKey: "apikey", visitorId: "Alex", config: config) { (_) in
