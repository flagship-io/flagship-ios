...
internal class FSContext {
    ...
    private var _currentContext: [String: Any] // by Default the context is empty

    internal var currentContext: [String: Any] {
    ...
    private var _currentModification: [String: Any]

    internal var currentModification: [String: Any] {
    ...
    internal func setNewContext(_ newContext: [String: Any]?) {
